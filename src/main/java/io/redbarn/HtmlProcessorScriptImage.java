...
public class HtmlProcessorScriptImage {
    ...
    /**
     * Gets all of the markup processed by the markup converter in a pretty
     * format.
     *
     * @param request The HTTP request associated with the conversion.
     * @return The formatted markup or an empty string if no markup was found.
     */
    public String getBeautifiedHtmlMarkup(HttpServletRequest request) {
        String[] params = getParameters();
        Object[] args = ServletUtils.getWebVariables(params, request);
